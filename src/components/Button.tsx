...
const variantStyles = {
  primary: 'bg-zinc-800 font-semibold text-zinc-100 hover:bg-zinc-700 active:bg-zinc-800 enabled:active:text-zinc-100/70 disabled:bg-zinc-800/90 disabled:text-zinc-50 dark:bg-zinc-700 dark:disabled:bg-zinc-600 dark:hover:bg-zinc-600',
